...
This document explains how to configure code signing for `kbs` release binaries so they don't trigger OS security warnings on macOS (Gatekeeper) or Windows (SmartScreen).
...
3. Generate a new password and label it (e.g., "kbs notarization")
